...
def loadFeatures(name):
    try:
        if name == 'feature_chinese.txt':
            file = open('feature_chinese.txt', 'r')
            feature = file.readlines()
        if name == 'feature_letter.txt':
            file = open('feature_letter.txt', 'r')
            feature = file.readlines()
        if name == 'feature_num_letter.txt':
            file = open('feature_num_letter.txt', 'r')
            feature = file.readlines()
        file.close()
        return feature
    except FileNotFoundError:
        print("No Files! check agagin!")
